 ...
 */
namespace PhpScoperExampleVendor\Composer;

use PhpScoperExampleVendor\Composer\Autoload\ClassLoader;
use PhpScoperExampleVendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('PhpScoperExampleVendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
