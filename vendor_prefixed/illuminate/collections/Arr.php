...
use ArrayAccess;
use Closure;
use PhpScoperExampleVendor\Illuminate\Contracts\Support\Arrayable;
use PhpScoperExampleVendor\Illuminate\Contracts\Support\Jsonable;
...
class Arr
{
    ...
    public static function first($array, ?callable $callback = null, $default = null)
    {
        if (\is_null($callback)) {
            ...
            if (\is_array($array)) {
                return \PhpScoperExampleVendor\array_first($array);
            }
            foreach ($array as $item) {
                return $item;
            }
        ...
        $key = \PhpScoperExampleVendor\array_find_key($array, $callback);
    ...
    {
        if (\is_null($callback)) {
            return empty($array) ? value($default) : \PhpScoperExampleVendor\array_last($array);
        }
    ...
    {
        return \PhpScoperExampleVendor\array_all($array, $callback);
    }
    /**
    ...
    {
        return \PhpScoperExampleVendor\array_any($array, $callback);
    }
    /**
    ...
    public static function join($array, $glue, $finalGlue = '')
    {
        ...
        if (\count($array) === 1) {
            return \PhpScoperExampleVendor\array_last($array);
        }
