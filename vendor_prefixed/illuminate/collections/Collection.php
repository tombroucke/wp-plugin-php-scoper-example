...
namespace PhpScoperExampleVendor\Illuminate\Support;

use ArrayAccess;
use ArrayIterator;
use PhpScoperExampleVendor\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use PhpScoperExampleVendor\Illuminate\Support\Traits\EnumeratesValues;
use PhpScoperExampleVendor\Illuminate\Support\Traits\Macroable;
use PhpScoperExampleVendor\Illuminate\Support\Traits\TransformsToResourceCollection;
...
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
    ...
    public function contains($key, $operator = null, $value = null)
    {
        if (\func_num_args() === 1) {
            if ($this->useAsCallable($key)) {
                return \PhpScoperExampleVendor\array_any($this->items, $key);
            }
    ...
    public function has($key)
    {
        ...
        return \PhpScoperExampleVendor\array_all($keys, fn($key) => \array_key_exists($key ?? '', $this->items));
    }
    /**
    ...
    public function hasAny($key)
    {
        ...
        $keys = \is_array($key) ? $key : \func_get_args();
        return \PhpScoperExampleVendor\array_any($keys, fn($key) => \array_key_exists($key ?? '', $this->items));
    }
    /**
    ...
    public function search($value, $strict = \false)
    {
        ...
        return \PhpScoperExampleVendor\array_find_key($this->items, $value) ?? \false;
    }
    /**
