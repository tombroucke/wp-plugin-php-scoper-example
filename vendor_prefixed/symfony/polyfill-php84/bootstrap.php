...
namespace PhpScoperExampleVendor;
 ...
 */
use PhpScoperExampleVendor\Symfony\Polyfill\Php84 as p;
...
if (!\function_exists('PhpScoperExampleVendor\\array_find')) {
    /** @internal */
...
if (!\function_exists('PhpScoperExampleVendor\\array_find_key')) {
    /** @internal */
...
if (!\function_exists('PhpScoperExampleVendor\\array_any')) {
    /** @internal */
...
if (!\function_exists('PhpScoperExampleVendor\\array_all')) {
    /** @internal */
...
if (!\function_exists('PhpScoperExampleVendor\\fpow')) {
    /** @internal */
...
if (\extension_loaded('mbstring')) {
    if (!\function_exists('PhpScoperExampleVendor\\mb_ucfirst')) {
        /** @internal */
    ...
    if (!\function_exists('PhpScoperExampleVendor\\mb_lcfirst')) {
        /** @internal */
    ...
    if (!\function_exists('PhpScoperExampleVendor\\mb_trim')) {
        /** @internal */
    ...
    if (!\function_exists('PhpScoperExampleVendor\\mb_ltrim')) {
        /** @internal */
    ...
    if (!\function_exists('PhpScoperExampleVendor\\mb_rtrim')) {
        /** @internal */
...
if (\extension_loaded('bcmath')) {
    if (!\function_exists('PhpScoperExampleVendor\\bcdivmod')) {
        /** @internal */
...
if (\extension_loaded('intl') && !\function_exists('PhpScoperExampleVendor\\grapheme_str_split')) {
    /** @internal */
